...
final int delayedAmount = 500;
  ...
  FocusNode namefocusnode,mobilefocusnode,collegefocusnode,statefocusnode,districtfocusnode;
...
Future<http.Response> _postRequest() async {
   ...
   CollectionReference collectionReference = Firestore.instance.collection('users').document(whiteprefs.getString('email')).collection('profile');
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: <Widget>[
             ...
             DelayedAnimation(child: welcomeTextRow(_width),delay: delayedAmount + 2000),
              DelayedAnimation(child:signInTextRow(),delay: delayedAmount + 3000),
  SizedBox(height: 10,),
             _page == 1 ? DelayedAnimation(child:form(),delay:delayedAmount+4000): form1(),
      ...
      children: <Widget>[
        Opacity(
          ...
          child: ClipPath(
            ...
            child: Container(
              height:_height/3.25,//_large? _height/4 : (_medium? _height/3.75 : _height/3.5),
        ...
        Opacity(
          ...
          child: ClipPath(
            ...
            child: Container(
              height: _height/3.5,//_large? _height/4.5 : (_medium? _height/4.25 : _height/4),
              decoration: BoxDecoration(
                gradient: LinearGradient(
                  colors: [Colors.orange[200], Colors.pinkAccent],
                ),
                      ...
                      hint: _dropDownCollegeValue == null
                          ? Row(
                            children:<Widget>[
                              ...
                              child:Icon(Icons.school,color:Colors.deepOrange,size:25)),
                              SizedBox(width:4.0),
                            Text('College Name',style:TextStyle(
                            fontSize: _width/30,
                          ...
                          :  Row(
                            children:<Widget>[
                              Padding(padding:new EdgeInsets.all(3.0),
                              child:Icon(Icons.book,color:Colors.deepOrange,size:25)),
                              SizedBox(width:4.0),
                            Text(_dropDownCollegeValue,style:TextStyle(
                            fontSize: _width/30,
                            color:Colors.black,
                    ...
                    child: DropdownButton(
                      ...
                      hint: _dropDownDistrictValue == null
                          ? Row(
                            children:<Widget>[
                              Padding(padding:new EdgeInsets.all(3.0),
                              child:Icon(Icons.location_on,color:Colors.deepOrange,size:25)),
                              SizedBox(width:4.0),
                          ...
                          : Row(
                            children:<Widget>[
                              ...
                              child:Icon(Icons.location_on,color:Colors.deepOrange,size:25)),
                              SizedBox(width:4.0),
                            Text(_dropDownDistrictValue,style:TextStyle(
                            fontSize: _width/30,
                            color:Colors.black,
                      ...
                      hint: _dropDownStateValue == null
                          ...
                          :  Row(
                            children:<Widget>[
                              ...
                              child:Icon(Icons.book,color:Colors.deepOrange,size:25)),
                              SizedBox(width:4.0),
                            Text(_dropDownStateValue,style:TextStyle(
                            fontSize: _width/30,
                            color:Colors.black,
...
Widget collegeTextFormField(){
   ...
   return  TextFormField(
        ...
        decoration: InputDecoration(
          ...
          errorText: _validatei ? 'Please type your institution name' : null,errorStyle:TextStyle(
            fontSize: _width/30,
...
new Padding(
  ...
  child:Text("Select Your Profession",style:TextStyle(
            fontSize: _width/30,
...
focusColor: Colors.red,
    ...
    new Text("student",
    style: TextStyle(fontSize: _width/30,
    fontWeight: FontWeight.bold,
    color: Colors.black,)),
    new Radio(
      value: 1,
...
SizedBox(
  child:
   _professionvalidate==true ? Padding(
     padding:EdgeInsets.all(10.0),
     child:Text("Please select your profession",
   style: TextStyle(
     fontSize: _width/30,
  ...
  Widget nameTextFormField() {
    return  TextFormField(
        ...
        decoration: InputDecoration(
          ...
          errorText: _validaten ? 'Name must contains atleast 4 characters' : null,errorStyle:TextStyle(
            fontSize: _width/30,
...
errorText: _validatem ? 'Invalid Mobile Number' : null,errorStyle:TextStyle(
  fontSize: _width/30
),
  ...
  Widget button() {
    return RaisedButton(
      ...
      child: Container(
        ...
        width: _width/3,//_large? _width/4 : (_medium? _width/3.75: _width/3.5),
        decoration: BoxDecoration(
        ...
        child:_page ==1 ? Text('next',style: TextStyle(fontSize:_width/20)):Text('submit',style: TextStyle(fontSize:_width/20)),
      ),
    );
  }
