                  ...
                  child: Container(
                    ...
                    child: Row(
                      ...
                      child:Column(children: <Widget>[
                         Image.asset("assets/scan.png",height: ht/5,width: wt/6,fit:BoxFit.fitWidth,),
                         Text("Live whiteboard",style: TextStyle(fontWeight:FontWeight.bold),),
                       ],) ),
                     /*  InkWell(
                         onTap:(){
                            Navigator.pushReplacement(
                        ...
                        child: Column(children: <Widget>[
                         Image.asset("assets/whiteboard.jpeg",height: ht/5,width: wt/6,fit:BoxFit.fitWidth,),
                         Text("whiteboard",style: TextStyle(fontWeight:FontWeight.bold),),
                       ],) )*/
